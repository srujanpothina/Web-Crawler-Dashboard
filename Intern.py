...
class InternSpider(scrapy.Spider):
    ...
    start_urls = (
        'https://www.glassdoor.com/Job/us-software-jobs-SRCH_IL.0,2_IN1_KO3,20.htm?fromAge=1&jobType=internship',
    )
    ...
    def parse(self, response):
        ...
        if(self.count < 30):
            ...
            if (df.to_csv('JobList_InternNew.csv', mode='a', index=False)):
                print("Success")
            ...
            for i in range(0,len(self.titles)):
                ...
                Values = [self.titles[i],"Internship",self.companies[i],self.city[i],self.state[i],self.min_sal[i],self.max_sal[i],self.ur[i],self.skills[i]]
